...
class MatchingRound extends Equatable {
  ...
  bool get isFilled =>
      userMatches.values.where((value) => value != null).length == leftItems.length;
  ...
  @override
  List<Object?> get props => [leftItems, rightItems, userMatches, correctPairs, leftSymbols, start, end];
}
