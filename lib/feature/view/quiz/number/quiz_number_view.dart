...
import 'package:elements_app/feature/mixin/quiz/number/quiz_number_mixin.dart';
...
class QuizNumberView extends StatefulWidget {
  final String apiType;
  final String title;
  const QuizNumberView({
    super.key,
    required this.title,
  ...
  @override
  _QuizNumberViewState createState() => _QuizNumberViewState();
}
