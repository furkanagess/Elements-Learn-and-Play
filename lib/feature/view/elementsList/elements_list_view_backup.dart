...
//                 ),
//                 Text(
//                   '${_filteredElements.length} element',
//                   style: TextStyle(
...
//                         Positioned.fill(
//                           child: CustomPaint(
//                             painter: _ElementCardPatternPainter(
...
//                     ),
//                     Text(
//                       isTr ? 'Bilgini Test Et' : 'Test Your Knowledge',
//                       style: TextStyle(
...
// class _ElementCardPatternPainter extends CustomPainter {
//   final Color color;

//   _ElementCardPatternPainter({required this.color});
