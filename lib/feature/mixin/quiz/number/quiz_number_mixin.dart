...
import 'package:elements_app/product/widget/sizedBox/horizontal_spacer.dart';
...
mixin QuizNumberMixin on State<QuizNumberView> {
  ...
  void askQuestion() {
    setState(() {
      ...
      correctAnswer = newElement.number.toString();
      ...
      while (options.length < 4) {
        PeriodicElement randomOption =
            elements[Random().nextInt(elements.length)];
        if (!options.contains(randomOption.number.toString())) {
          options.add(randomOption.number.toString());
        }
      }
                          ...
                          child: Center(
                            child: Row(
                              ...
                              children: [
                                ...
                                const HorizontalSpacer(width: 0.01),
                                SvgPicture.asset(
